...
public class UsuarioService {
    ...
    public UsuarioSaidaDTO buscarUsuario(Long id){
        UsuarioSaidaDTO saida = UsuarioMapper.toDTO(buscarUsuarioPorId(id));
        log.info("Usuario {} encontrado com sucesso", saida.getNome());
