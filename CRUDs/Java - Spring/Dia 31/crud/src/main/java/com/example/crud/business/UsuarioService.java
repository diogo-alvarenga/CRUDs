...
public class UsuarioService {
	...
	private String notFound = "Usuario não encontrado.";
	...
	public SaidaDTO atualizarUsuario(EntradaComIdDTO entrada) {
		Usuario usuarioEntity = repository.findById(entrada.getId()).orElseThrow(
				()-> new EntityNotFoundException(notFound));
	...
	public String deletarPorId(Long id) {
		...
		return "Usuario de email "+ usuario.getEmail() + " deletado com sucesso!";
	}
