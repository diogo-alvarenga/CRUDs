...
public class UsuarioController {
	...
	@ApiResponses(value = {
			...
			@ApiResponse(responseCode = "500", description = "Erro ao listar todos")
	})
	@GetMapping
	...
	@Operation(summary = "Efetuar teste de login", method = "POST")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Teste de login efetuado com sucesso"),
			@ApiResponse(responseCode = "", description = "Erro ao fazer teste de login")
	})
	@PostMapping("/login")
