...
public class UsuarioController {
	...
	public ResponseEntity<UsuarioDTO> adicionarUsuario(@RequestBody Usuario usuario){
		...
		dto.add(linkTo(methodOn(UsuarioController.class).adicionarUsuario(usuario)).withSelfRel());
		dto.add(linkTo(methodOn(UsuarioController.class).deletarUsuario(null)).withRel("deletar"));
		dto.add(linkTo(methodOn(UsuarioController.class).listarTodos()).withRel("listar"));
		dto.add(linkTo(methodOn(UsuarioController.class).atualizarUsuario(usuario, null)).withRel("atualizar"));
	...
	public ResponseEntity<UsuarioDTO> atualizarUsuario(@RequestBody Usuario usuario,@RequestParam Long id){
		...
		dto.add(linkTo(methodOn(UsuarioController.class).atualizarUsuario(usuario, id)).withSelfRel());
		dto.add(linkTo(methodOn(UsuarioController.class).adicionarUsuario(usuario)).withRel("adicionar"));
		dto.add(linkTo(methodOn(UsuarioController.class).deletarUsuario(id)).withRel("deletar"));
		dto.add(linkTo(methodOn(UsuarioController.class).listarTodos()).withRel("listar"));
